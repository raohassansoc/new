...
const OverviewMain = () => {
  ...
  return (
    <div className="flex">
      <div className="w-[20%] border-r text-white bg-[#161616] max-sm:w-14 max-sm:overflow-hidden">
        <div className="border-b py-5 pl-4 flex  items-center">
          <PreviewIcon />
          <span className="pl-5 text-base font-semibold max-sm:invisible">
            Home
          </span>
        </div>
      ...
      <div className="w-[90%] text-white">
        <h1 className="text-3xl py-7 pl-6 bg-[#161616]">Wallet Overview</h1>
        <div className="flex max-lg:flex-wrap">
            ...
            <div className="p-6 max-sm:p-2">
              ...
              <div className="mt-6">
                ...
                {array.map((wallet, index) => {
                  return (
                    <div
                      className="flex justify-between items-center border-b p-5 max-md:p-2 bg-[#161616]"
                      key={index}
                    >
                      ...
                      <div>
                        <button className="p-2 px-7  bg-[#e50914] rounded-sm text-white font-bold text-xs">
                          Buy
                        </button>
                      </div>
                    </div>
          ...
          <div className="w-[35%] border-t max-lg:w-[100%] max-lg:m-6 pb-6 max-sm:m-2">
            <div className="bg-[#161616] h-[100%] ">
